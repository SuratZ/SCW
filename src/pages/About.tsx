...
export default function About() {
    return (
        <Container sx={{
            ...
            <Typography color="text.primary" variant="h6" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }} >
                About us
            </Typography>
            ...
            >
            <Box>
                <Typography color="text.secondary" variant="body2" align="left" fontSize={18} paragraph
                sx={{
                    ml: 45,
                    mr: 45,
                }}>
